                                    ...
                                    return AlertDialog(
                                        ...
                                        content: Column(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: StreamBuilder<QuerySnapshot> (
                                                    stream: FirebaseFirestore.instance.collection('income').where('user',whereIn: ['admin',currentuserid]).snapshots(),
                                                    builder: (context, snapshot) {
                                                      ...
                                                      Center(
                                                        child: Text('No income category ',style: TextStyle(
                                                            fontSize: 15,
                                                            fontFamily: 'urbanist',
                                                            fontWeight: FontWeight.w500
                                                        ),),
                                            ...
                                            InkWell(
                                              onTap: (){
                                                 Navigator.push(context, MaterialPageRoute(builder: (context)=>IncomeCategoryPage()));
                                              },
                                              child: Center(
                                                child: Container(
                                                  width: scrWidth*0.8,
                            ...
                            return AlertDialog(
                              ...
                              actions: [
                                ...
                                TextButton(onPressed: (){
                                  ...
                                  showUploadMessage(context, 'Income  added succesfully');
