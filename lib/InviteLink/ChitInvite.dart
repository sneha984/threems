...
class ChitInvite extends StatefulWidget {
  final String id;
  const ChitInvite({Key? key, required this.id}) : super(key: key);

  @override
  State<ChitInvite> createState() => _ChitInviteState();
}

class _ChitInviteState extends State<ChitInvite> {
