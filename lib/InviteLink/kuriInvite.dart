...
import '../products/const.dart';
import '../screens/splash_screen.dart';
import '../utils/customclip2.dart';
import '../utils/themes.dart';

class KuriInvitePage extends StatefulWidget {
  final String id;
  const KuriInvitePage({Key? key, required this.id}) : super(key: key);

  @override
  State<KuriInvitePage> createState() => _KuriInvitePageState();
}

class _KuriInvitePageState extends State<KuriInvitePage> {
  KuriModel? kuri;
      ...
      builder: (context) {
        return AlertDialog(
          ...
          contentPadding: EdgeInsets.only(
              ...
              right: scrWidth * 0.02),
          title: Text(
            "Are you sure want to join this Kuri?",
            style: TextStyle(
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      FirebaseFirestore.instance
                        ...
                        showSnackbar(context,
                            'Successfully joined the kuri named ${kuri!.kuriName!}');
