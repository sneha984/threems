...
import 'package:threems/Expenses/Report/ExpenseReportByDate.dart';
...
class SelectDateRange extends StatefulWidget {
  const SelectDateRange({Key? key}) : super(key: key);
...
class _SelectDateRangeState extends State<SelectDateRange> {
  ...
  //     children: [
  //       Padding(
  //         padding:  EdgeInsets.only(left: scrWidth*0.08,right:  scrWidth*0.08,top:scrWidth*0.19 ),
  //         child: Container(
  //           height: scrWidth*0.11,
  //           child: Row(
  //             mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      // Navigator.of(context).pop({"fromDate":fromDate,"toDate":toDate});
                       Navigator.push(context, MaterialPageRoute(builder: (context)=>ReportByDatePage(
                         fromDate:fromDate,
                         toDate:toDate
                       )));
                    },
