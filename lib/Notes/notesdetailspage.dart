...
//DatePick----------------
  ...
  showNotification() {
    ...
    flutterLocalNotificationsPlugin.zonedSchedule(01, widget.notes['title'],
        widget.notes['content'], scheduledAt, notificationDetails,
                            ...
                            onPressed: () {
                              ...
                              showDialog(
                                ...
                                builder: (ctx) => AlertDialog(
                                  content:
                                      const Text("Do You Want to save this"),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {
              ...
              child: SingleChildScrollView(
                child: Padding(
                  padding: EdgeInsets.only(
                      left: scrWidth * 0.034, right: scrWidth * 0.034),
                  child: Column(
                    children: [
                      Row(
                        children: [
                        ...
                        children: [
                          ...
                          Transform.scale(
                            ...
                            child: CupertinoSwitch(
                              thumbColor:
                                  _remainder ? Color(0xff02B558) : Colors.grey,
                                ...
                                decoration: InputDecoration(
                                  suffixIcon: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      _time.text =
                                          "${slectedTime.hour == 0 ? 12 : slectedTime.hour}: ${slectedTime.minute.toString().length == 1 ? '0${slectedTime.minute.toString()}' : slectedTime.minute.toString()}";
