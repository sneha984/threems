          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                      ...
                      GestureDetector(
                        onLongPress: () {
                          Clipboard.setData(ClipboardData(
                              text: widget.charitymodel.phoneNumber!));
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: Image(
                              image:
                                  AssetImage("assets/images/paytm (1).png"))),
                      SizedBox(
                        width: scrWidth * 0.01,
                      ),
                      Container(
                          ...
                          child: Image(
                              image:
                                  AssetImage("assets/images/whatsp pay.png"))),
                      SizedBox(
                        width: scrWidth * 0.01,
                      ),
                      Container(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                    "assets/images/card desigbn.png"),
                                fit: BoxFit.fill)),
                      ),
                      Positioned(
                          top: scrHeight * 0.04,
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        right: scrWidth * 0.62, bottom: scrHeight * 0.02),
                    child: Text(
                      "Scan Qr Code",
                      style: TextStyle(
