...
class _PaymentPageState extends State<PaymentPage> {
  ...
  getIconData() {
    FirebaseFirestore.instance
        .collection('expenses')
        .where('expenseName', isEqualTo: 'charity')
        .snapshots()
        .listen((event) {
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.charitymodel.image!),
                          fit: BoxFit.fill)),
                ),
                SizedBox(
                ...
                Column(
                  ...
                  children: [
                    Container(
                      width: scrWidth * 0.56,
                      child: Text(widget.charitymodel.charityDetailes!,
                          style: TextStyle(
                    ...
                    Row(
                      children: [
                        Text(widget.charitymodel.beneficiaryName!,
                            style: TextStyle(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            bottom: scrHeight * 0.014, left: scrWidth * 0.03),
                        child: Container(
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onLongPress: () {
                    Clipboard.setData(
                        ClipboardData(text: widget.charitymodel.phoneNumber!));
            ...
            Row(
              children: [
                ...
                Container(
                    ...
                    width: scrWidth * 0.04,
                    child:
                        Image(image: AssetImage("assets/images/phonepe.png"))),
                SizedBox(
                  width: scrWidth * 0.02,
                ),
                Container(
                ...
                Container(
                    ...
                    width: scrWidth * 0.09,
                    child: Image(
                        image: AssetImage("assets/images/amaz pay (1).png"))),
              ],
            ),
            SizedBox(
              height: scrHeight * 0.01,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "IFSC : ${widget.charitymodel.ifscCode}",
                                style: TextStyle(
                                    fontSize: 14,
                                    fontFamily: 'Urbanist',
                                    fontWeight: FontWeight.w700,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.charitymodel.accountHolderName!,
                                style: TextStyle(
                                    fontSize: 16,
                                    fontFamily: 'Urbanist',
                                    fontWeight: FontWeight.w700,
                              ...
                              Text(
                                widget.charitymodel.accountNumber!,
                                style: TextStyle(
                                    fontSize: 16,
                                    fontFamily: 'Urbanist',
                                    fontWeight: FontWeight.w700,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: NetworkImage(widget.charitymodel.qrImage ?? ''),
                      fit: BoxFit.fill)),
            ),
            SizedBox(
              height: 20,
        ...
        onTap: () {
          FirebaseFirestore.instance
            ...
            'totalReceived': FieldValue.increment(
                double.tryParse(valueAmountController.text)!)
          });
          FirebaseFirestore.instance
              .collection('users')
              .doc(currentuserid)
