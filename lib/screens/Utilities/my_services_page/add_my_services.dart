...
class AddMyServicePage extends StatefulWidget {
  // final String subCategoryName;
  // final String Category;
  final ServiceDetails? serviceItems;
  const AddMyServicePage({Key? key, this.serviceItems,
    // required this.subCategoryName, required this.Category,
  }) : super(key: key);

  @override
  State<AddMyServicePage> createState() => _AddMyServicePageState();
}

class _AddMyServicePageState extends State<AddMyServicePage>  with TickerProviderStateMixin{
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              editService==false?  InkWell(
                                  onTap: () {
                                    if(name?.text!='' &&phoneNumber?.text!='' &&whatsappNumber?.text!=''
