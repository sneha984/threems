...
class _AddedKuriPublicState extends State<AddedKuriPublic> {
  ...
  getkuriUser() {
    FirebaseFirestore.instance
        .collection('users')
        .doc(widget.kuri.userID!)
        .snapshots()
        .listen((event) {
      currentKuriUser = UserModel.fromJson(event.data()!);
    });
  }
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "The room created by ${currentKuriUser?.userName!}",
                              style: TextStyle(
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => KuriPaymentPage()));
              },
              child: Container(
