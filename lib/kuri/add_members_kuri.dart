...
class AddMembersKuri extends StatefulWidget {
  const AddMembersKuri({Key? key}) : super(key: key);
    ...
    Navigator.pop(context);
      ...
      child:  Padding(
        padding: EdgeInsets.only(top: scrHeight*0.03,
            left: scrWidth*0.05,bottom: scrHeight*0.015,right: scrWidth*0.05),
        ...
        actions: [
          GestureDetector(
            onTap: (){
              Navigator.push(context,MaterialPageRoute(builder: (context)=>AddMembersearch()));
            },
            child: Padding(
              padding:  EdgeInsets.only(top: scrHeight*0.04,bottom: scrHeight*0.03,right: scrWidth*0.025),
              child: Container(
                width: scrWidth*0.13,
                ...
                child: Padding(
                  padding: EdgeInsets.only(top:scrHeight*0.007 ,bottom: scrHeight*0.01),
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => Padding(
                  padding: EdgeInsets.only(top: scrWidth * 0.02,left: scrWidth*0.047,right: scrWidth*0.047),
                  child: Container(
                    width: scrWidth*0.2,
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text("Send the link via Whatsapp if the person is not install the app",style: TextStyle(
                  fontFamily: 'Urbanist',fontSize: scrWidth*0.027,fontWeight: FontWeight.w500,color: Color(0xff827E7E)
                ),),
              ),
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        "Create New Kuri",style: TextStyle(fontWeight: FontWeight.w500,fontSize: scrWidth*0.04,fontFamily: 'Outfit',color: Colors.white),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Invite",style: TextStyle(fontWeight: FontWeight.w500,fontSize: scrWidth*0.04,fontFamily: 'Outfit',color: Colors.white),)
                      ],
                    ),
                  ),
