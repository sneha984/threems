          ...
          children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: 150,
                                    child: Text(
                                      widget.orderMdl.orderedItems![index].item!,
                                      style: TextStyle(
                                          fontSize: 16,
                                          color: Colors.black,
                                          fontFamily: 'Urbanist',
                                  ...
                                  Text(
                                    widget.orderMdl.orderedItems![index].count!.toString()
                                    ,
                                    style: TextStyle(
                                        fontSize: 16,
                                        color: Colors.black,
            ...
            Row(
              children: [
                ...
                InkWell(
                  onTap: (){
                    FirebaseFirestore.instance.collection('stores').doc(widget.orderMdl.storeId).collection('orders').doc(widget.orderMdl.orderId).update({
                      'status':3
                    });
                  },
                  child: Text(
